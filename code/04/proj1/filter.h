...
void my_fir( const fract16 x[],fract16 y[],int n,fir_state_fr16 *s );	
void _myDfir( const fract16 x[],fract16 y[],int n,fir_state_fr16 *s );	
void _myfir_Smac_asm( const fract16 x[],fract16 y[],int n,fir_state_fr16 *s );
void _myfir_Dmac_asm( const fract16 x[],fract16 y[],int n,fir_state_fr16 *s );	
