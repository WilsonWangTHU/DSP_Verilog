...
Prototype:
		void fir(const fract16 x[],fract16 y[],int n,fir_state_fr16 *s, int step);
...
E_MAC_END:		A1+=R0.H*R2.L,A0+=R0.H*R2.H  || R2.H=W[I2++] ;	//A1+=X-1*h2, A0+=X-1*h1
		        ...
		        R3.H=(A1+=R0.L*R2.H),R3.L=(A0+=R0.L*R2.L)  || R0.L=W[P0++P5] || R1=[I0]; 
			    ...
			    W[P4++P5] = R3.L;	    // Store the final filtered output, even sample
E_FIR_END:      W[P4++P5] = R3.H;       // Store the final filtered output, odd sample
